...
g <- ggplot(df.long) +
  ...
  geom_vline(xintercept=1678196700,color="red",alpha=0.5) +
  annotate("text", x=1678196700, y=12, label="a)",size = 18/.pt) +
  geom_vline(xintercept=1678197600,color="red",alpha=0.5) +
  annotate("text", x=1678197600, y=12, label="b)",size = 18/.pt) +
  geom_vline(xintercept=1678198500,color="red",alpha=0.5) +
  annotate("text", x=1678198500, y=12, label="c)",size = 18/.pt) + 
  geom_vline(xintercept=1678199400,color="red",alpha=0.5) +
  annotate("text", x=1678199400, y=12, label="d)",size = 18/.pt) + 
  geom_vline(xintercept=1678200300,color="red",alpha=0.5) +
